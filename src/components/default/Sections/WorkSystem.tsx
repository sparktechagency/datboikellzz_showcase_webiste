...
function WorkSystem() {
    ...
    return (
        <div className='container mx-auto py-12 md:py-28'>
            <div className='flex flex-col mb-12 items-center gap-4'>
                <h1 className="font-poppins font-semibold text-5xl text-center tracking-normal leading-none">How <span className='text-[#E5B92E]'>BetWise</span> Works</h1>
                <p>Getting started is easy — just three simple steps to unlock expert insights and start betting smarter.</p>
            </div>
            <div className="grid grid-cols-1 gap-7 md:grid-cols-3 px-3">
                {
                    workFlow.map((item, index) => (
                        <div key={index} className='relative p-6 md:p-12 rounded-md overflow-hidden shadow-sm md:shadow-sm flex flex-col md:items-start'>
